...
console.log('ModalContainer.create');
console.log(this);
  // Load the template
...
console.log('ModalContainer.render');
console.log(this);
...
console.log('ModalContainer.calculateDimensions');
console.log(this);
  var minw = 60;
  var minh = 80;
...
console.log('ModalContainer.bindEvents');
console.log(this);
console.log(Dialog);
  ...
  //   - close-class = 'virtru-close'
  //   - OR: close-class = '.virtru-close'
  closeClass = closeClass.replace(/^\.*/, '.');
console.log('closeClass = ' + closeClass);
  this.modalContainer.find(closeClass).click(function() {
console.log('modalContainer close-class button clicked: ' + closeClass);
console.log(Dialog);
    Dialog.close();
    return false;
  });
